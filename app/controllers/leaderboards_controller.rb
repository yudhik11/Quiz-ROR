class LeaderboardsController < ApplicationController
  ...
  def index
    ...
    @leadermovie = Leaderboard.order('hmax+bmax DESC')
    @leadersports = Leaderboard.order('cmax+fmax DESC')
  end
  ...
  private
    ...
    def leaderboard_params
      params.require(:leaderboard).permit(:user_id, :Football, :Cricket, :Hollywood, :Bollywood)
    end
end
