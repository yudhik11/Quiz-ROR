...
class FootballsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create football" do
    assert_difference('Football.count') do
      post footballs_url, params: { football: { answer: @football.answer, option1: @football.option1, option2: @football.option2, option3: @football.option3, option4: @football.option4, question: @football.question } }
    end
  ...
  test "should update football" do
    patch football_url(@football), params: { football: { answer: @football.answer, option1: @football.option1, option2: @football.option2, option3: @football.option3, option4: @football.option4, question: @football.question } }
