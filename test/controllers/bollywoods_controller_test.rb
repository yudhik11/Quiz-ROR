...
class BollywoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bollywood" do
    assert_difference('Bollywood.count') do
      post bollywoods_url, params: { bollywood: { answer: @bollywood.answer, mcq: @bollywood.mcq, option1: @bollywood.option1, option2: @bollywood.option2, option3: @bollywood.option3, option4: @bollywood.option4, question: @bollywood.question } }
    end
  ...
  test "should update bollywood" do
    patch bollywood_url(@bollywood), params: { bollywood: { answer: @bollywood.answer, mcq: @bollywood.mcq, option1: @bollywood.option1, option2: @bollywood.option2, option3: @bollywood.option3, option4: @bollywood.option4, question: @bollywood.question } }
