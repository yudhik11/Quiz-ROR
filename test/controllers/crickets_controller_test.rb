...
class CricketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cricket" do
    assert_difference('Cricket.count') do
      post crickets_url, params: { cricket: { answer: @cricket.answer, option1: @cricket.option1, option2: @cricket.option2, option3: @cricket.option3, option4: @cricket.option4, question: @cricket.question } }
    end
  ...
  test "should update cricket" do
    patch cricket_url(@cricket), params: { cricket: { answer: @cricket.answer, option1: @cricket.option1, option2: @cricket.option2, option3: @cricket.option3, option4: @cricket.option4, question: @cricket.question } }
