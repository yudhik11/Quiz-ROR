...
class HollywoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hollywood" do
    assert_difference('Hollywood.count') do
      post hollywoods_url, params: { hollywood: { answer: @hollywood.answer, mcq: @hollywood.mcq, option1: @hollywood.option1, option2: @hollywood.option2, option3: @hollywood.option3, option4: @hollywood.option4, question: @hollywood.question } }
    end
  ...
  test "should update hollywood" do
    patch hollywood_url(@hollywood), params: { hollywood: { answer: @hollywood.answer, mcq: @hollywood.mcq, option1: @hollywood.option1, option2: @hollywood.option2, option3: @hollywood.option3, option4: @hollywood.option4, question: @hollywood.question } }
